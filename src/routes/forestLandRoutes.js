...
router.post(
    ...
    handleUpload(uploadStage0.fields([
        { name: "dgps_document", maxCount: 30},
        { name: "orsac_document", maxCount: 30},
        { name: "tree_enumeration_document", maxCount: 30},
        { name: "administrative_document", maxCount: 30},
        { name: "legal_lease_document", maxCount: 30},
        { name: "technical_document", maxCount: 30},
        { name: "forest_land_details_document", maxCount: 30},
        { name: "ca_ca_document", maxCount: 30},
        { name: "fra_document", maxCount: 30},
        { name: "environmental_document", maxCount: 30},
        { name: "wildlife_document", maxCount: 30},
        { name: "maps_document", maxCount: 30},
        { name: "financial_document", maxCount: 30},
        { name: "proposal_document", maxCount: 30},
...
router.post(
    ...
    handleUpload(uploadStage1.fields([
        { name: "stage1_approval_document", maxCount: 30},
        { name: "stage1_conditions_document", maxCount: 30},
        { name: "ca_land_document", maxCount: 30},
        { name: "fra_document", maxCount: 30},
        { name: "npv_document", maxCount: 30},
        { name: "ca_payment_document", maxCount: 30},
        { name: "aca_payment_document", maxCount: 30},
        { name: "wildlife_payment_document", maxCount: 30},
        { name: "technical_document", maxCount: 30},
        { name: "stage1_acceptance_document", maxCount: 30},
...
router.post(
    ...
    handleUpload(uploadStage2.fields([
        { name: "environmental_document", maxCount: 30},
        { name: "nbwl_document", maxCount: 30},
        { name: "final_ca_document", maxCount: 30},
        { name: "final_maps_document", maxCount: 30},
        { name: "final_technical_document", maxCount: 30},
        { name: "stage2_approval_document", maxCount: 30},
...
router.post(
    ...
    handleUpload(uploadPostClearance.fields([
        { name: "ca_plantation_started_document", maxCount: 30},
        { name: "ca_plantation_completed_document", maxCount: 30},
        { name: "survival_report_document", maxCount: 30},
        { name: "wildlife_mitigation_document", maxCount: 30},
        { name: "safety_zone_document", maxCount: 30},
